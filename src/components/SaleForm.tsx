...
// los chips activos de tipo usan el teal de marca desde tokens.
const ACCENT = token.accent.base;
...
export default function SaleForm({ businessId, onSuccess, onClose, transaction, rubro }: Props) {
  ...
  // D-20.b — ¿cambios sin guardar? En new: arrancó a cargar (monto o desc). En
  // edit: algún campo difiere del valor inicial de la transacción. El clic afuera
  // / Esc piden confirmación antes de descartar (ModalShell). El × cierra directo.
  ...
  return (
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.fieldRow}>
            ...
            <View style={styles.fieldDescription}>
              ...
              <TextInput
                style={styles.input}
                placeholder="Ej: Cliente Juan, 3 u."
                placeholderTextColor="#4A4A6A"
                value={description}
    ...
    {/* F1-L: modal de creación de categoría custom. Fuera del ModalShell para
        no anidar Modals — se monta encima cuando showAddCategory. */}
    <AddCategoryModal
...
const styles = StyleSheet.create({
  ...
  amountRow: {
    ...
    borderWidth: 1, borderColor: '#1A6B3A', paddingHorizontal: 14,
  },
  currency: { color: '#1A6B3A', fontSize: 20, fontWeight: 'bold', marginRight: 8 },
  amountInput: {
  ...
  saveBtn: {
    backgroundColor: '#1A6B3A', paddingVertical: 13,
